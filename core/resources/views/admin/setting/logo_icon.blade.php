                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            <div class="form-group col-lg-4">
                                ...
                                <x-image-uploader name="pwa_thumb" :imagePath="getImage(getFilePath('logoIcon') . '/pwa_thumb.png', '?' . time())" :size="getFileSize('pwa_thumb')" class="w-100" id="pwaThumb" :required="false" />
                            </div>
                            <div class="form-group col-lg-4">
                                <label>@lang('PWA Favicon')</label>
                                <x-image-uploader name="pwa_favicon" :imagePath="getImage(getFilePath('logoIcon') . '/pwa_favicon.png', '?' . time())" :size="getFileSize('pwa_favicon')" class="w-100" id="pwaFavicon" :required="false" />
                            </div>
                        </div>
